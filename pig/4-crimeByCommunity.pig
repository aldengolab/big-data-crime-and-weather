...
STORE SUMMED_CRIMES_BY_COMM INTO 'hbase://summed_crimes_by_community'
  USING org.apache.pig.backend.hadoop.hbase.HBaseStorage(
    'crime:num_homicides, crime:num_robberies, crime:num_batteries,
     crime:num_assaults, crime:num_burglaries, crime:num_thefts,
     crime:num_narcotics, crime:num_other, crime:crime_count');
