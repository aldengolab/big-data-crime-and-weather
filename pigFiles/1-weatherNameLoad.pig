...
register /home/mpcs53013/agolab/jars/IngestWeather-0.0.1-SNAPSHOT.jar;
...
STATION_CODE_LINES = LOAD '/agolab/inputs/weathergeo/station_codes.txt' as line;
...
RAW_WEATHER_DATA = LOAD '/agolab/inputs/thriftWeather/weather-*' USING org.apache.pig.piggybank.storage.SequenceFileLoader() as (key:long, value: bytearray);
...
STORE CHICAGO_WEATHER INTO '/agolab/inputs/chicago_weather' USING PigStorage(',');
