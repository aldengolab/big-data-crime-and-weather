CRIMES = LOAD '/agolab/inputs/chicagoCrimeWeather' USING PigStorage(',') 
...
STORE CRIME_WEATHER INTO 'hbase://agolab_crime_weather_sums'
  USING org.apache.pig.backend.hadoop.hbase.HBaseStorage(
    'weather:count, weather:meanTemp, weather:fog, weather:rain, 
     weather:snow, weather:hail, weather:thunder, weather:tornado, 
     weather:clear');
